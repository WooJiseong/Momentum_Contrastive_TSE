...
# Keep the standalone SIA-nonmun lab independent of a Slurm-side cache setup.
# This must happen before importing espnet/resemblyzer because librosa/numba
# may initialize their cache during the speedup installation below.
os.environ.setdefault(
    "NUMBA_CACHE_DIR",
    f"/tmp/sia_nonmun_numba_cache_{os.environ.get('USER', 'user')}",
)
