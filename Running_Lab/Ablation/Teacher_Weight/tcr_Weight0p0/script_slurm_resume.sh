#!/usr/bin/env bash
# Resume Teacher Weight 0.0 Stage0 from the full Lightning checkpoint.
...
#SBATCH --job-name=tcr0p0_s0_resume
...
export NUMBA_CACHE_DIR="${NUMBA_CACHE_DIR:-/tmp/tcr_weight0p0_resume_numba_cache_${USER:-user}}"
