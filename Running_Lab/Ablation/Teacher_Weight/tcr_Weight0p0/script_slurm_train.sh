#!/usr/bin/env bash
# Teacher-weight ablation: fixed teacher coefficient 0.0.

#SBATCH -D /gpfs/home1/wjs6800/SIALab/PNFlowTSE/contrastive_momentum/Running_Lab/Ablation/Teacher_Weight/tcr_Weight0p0
#SBATCH -p gpu6
#SBATCH --gres=gpu:a10:4
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --time=120:00:00
#SBATCH --job-name=tcr0p0_s0
#SBATCH --output=slurm-%j.out

set -euo pipefail

LAB_DIR="/gpfs/home1/wjs6800/SIALab/PNFlowTSE/contrastive_momentum/Running_Lab/Ablation/Teacher_Weight/tcr_Weight0p0"
CONFIG="$LAB_DIR/config_stage0.yaml"
PYTHON_BIN="/home1/wjs6800/miniconda3/envs/pnflowtse/bin/python"

export MASTER_PORT="${MASTER_PORT:-30130}"
export OMP_NUM_THREADS="${OMP_NUM_THREADS:-4}"
export MKL_NUM_THREADS="${MKL_NUM_THREADS:-4}"
export NUMBA_CACHE_DIR="${NUMBA_CACHE_DIR:-/tmp/tcr_weight0p0_numba_cache_${USER:-user}}"
...
echo "[TeacherWeightAblation] teacher_weight=0.0"
