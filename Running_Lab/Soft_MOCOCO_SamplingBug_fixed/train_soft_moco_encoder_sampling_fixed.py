"""Soft_MOCOCO trainer using the unified-speaker dataset adapter."""
...
base_spec = importlib.util.spec_from_file_location(
    "pn_mococo_sampling_fixed_base_train",
...
from unified_speaker_data import get_dataloaders


class SoftLightningModule(base_train.LightningModule):
    """Keep the original Soft loss and swap only the Stage0 data adapter."""
